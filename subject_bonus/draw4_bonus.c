...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/25 14:59:20 by hyungdki          #+#    #+#             */
/*   Updated: 2023/07/25 17:39:36 by hyungdki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf_bonus.h"

static void	draw_horizontal_line2(t_fdf *fdf, t_point sxp, t_point bxp);
static void	draw_horizontal_line3(t_fdf *fdf,
...
void	draw_horizontal_line(t_fdf *fdf, t_point p1, t_point p2)
{
	...
	draw_horizontal_line2(fdf, sxp, bxp);
}
...
static void	draw_horizontal_line2(t_fdf *fdf, t_point sxp, t_point bxp)
{
	...
	draw_horizontal_line3(fdf, sxp, bxp, color_box);
}
